...
[_MOD2D] = LAYOUT_planck_mit( \
  KC_LSFT, KC_Q,    KC_C,    KC_U,    KC_D,    CMD,     CMD,     KC_J,    KC_K,    KC_L,    KC_Y,    KC_RSFT, \
  KC_ESC,  KC_A,    KC_S,    KC_E,    KC_T,    KC_G,    KC_H,    KC_I,    KC_O,    KC_N,    KC_R,    KC_ENT, \
  KC_TAB,  KC_NO,   KC_F,    KC_M,    MOD2L,   KC_NO,   KC_NO,   MOD2L,   KC_P,    KC_COMM, KC_DOT,  KC_BSPC, \
  KC_LCTL, KC_LALT, KC_LGUI, CMD,     EXT,        KC_SPACE,      EXT,     CMD,     KC_RGUI, KC_RALT, KC_RCTL \
),
...
[_MOD2L] = LAYOUT_planck_mit( \
  _______, _______, _______, _______, _______, CMD,     CMD,     _______, KC_X,    _______, _______, _______, \
  _______, _______, KC_Z,    _______, _______, _______, KC_W,    KC_Y,    _______, _______, _______, _______, \
  _______, _______, KC_V,    _______, _______, _______, _______, _______, KC_B,    _______, _______, _______, \
  _______, _______, _______, _______, _______,     _______,      _______, _______, _______, _______, _______ \
),
